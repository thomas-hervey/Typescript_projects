...
const summary = new Summary_1.Summary(new WinsAnalysis_1.WinsAnalysis('Man United'), new HtmlReport_1.HtmlReport() // NOTE: alternate is to use ConsoleReport, either works here!
);
